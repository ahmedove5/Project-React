    ...
    <div>
      ...
      <Carousel.Item>
        <img
          ...
          src="https://media.wired.com/photos/59265d82f3e2356fd8009019/master/w_2400,c_limit/LightsTA-515066888-Converted.gif"
          alt="First slide"
          height={"500px"}
        />
        <Carousel.Caption>
          <h3 className='text-dark'>نُضيءُ لَك
            طَرِيق الْوُصُولِ إلَى عُملائك</h3>
      ...
      <Carousel.Item>
        <img
          className="d-block w-100 "
          src="https://gifimage.net/wp-content/uploads/2017/10/creatividad-gif.gif"
          alt="Second slide"
          height={"500px"}
          dir='ltr'
        />
                <Carousel.Caption>
          <h3 className='text-dark'>إذا لم يكن لأعمالك وجود على الإنترنت فستختفي من قائمة الأعمال</h3>
        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_title">
              <h3>بوابتك الى الابتكار مع شريكك</h3>
            </div>
